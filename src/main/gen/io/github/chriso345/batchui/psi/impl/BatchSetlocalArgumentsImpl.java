...
public class BatchSetlocalArgumentsImpl extends ASTWrapperPsiElement implements BatchSetlocalArguments {

  public BatchSetlocalArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitSetlocalArguments(this);
  }
