...
public class BatchColorArgumentsImpl extends ASTWrapperPsiElement implements BatchColorArguments {

  public BatchColorArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitColorArguments(this);
  }
