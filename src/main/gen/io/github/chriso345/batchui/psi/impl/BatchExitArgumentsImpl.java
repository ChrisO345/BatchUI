...
public class BatchExitArgumentsImpl extends ASTWrapperPsiElement implements BatchExitArguments {

  public BatchExitArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitExitArguments(this);
  }
