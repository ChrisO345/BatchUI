...
public class BatchDateArgumentsImpl extends ASTWrapperPsiElement implements BatchDateArguments {

  public BatchDateArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitDateArguments(this);
  }
