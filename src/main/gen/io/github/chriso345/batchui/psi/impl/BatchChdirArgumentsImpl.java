...
public class BatchChdirArgumentsImpl extends ASTWrapperPsiElement implements BatchChdirArguments {

  public BatchChdirArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitChdirArguments(this);
  }
