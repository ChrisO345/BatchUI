...
public class BatchAssocArgumentsImpl extends ASTWrapperPsiElement implements BatchAssocArguments {

  public BatchAssocArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitAssocArguments(this);
  }
